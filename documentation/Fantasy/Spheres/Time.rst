...
**Описание**
  ...
  Маги Сферы Времени утверждают что время течет нелинейно, мир полон нискажений, завихрений и темпоральных возмущений. Время ускоряется в одних местах и замедляется у других. При необычных обстоятельствах время может закольцеваться, в нем могут происходить прыжки и провалы в прошлое или будущее. Опытный Маг может чувствовать все эти феномены, но они редко предсказуемы и не очень безопасны.
...
**Эффекты**
  ...
  11-13 Путешествие во времени, иммунитет ко времени
...
**Типичные заклинания**
  ...
  7 Искажение времени
    ...
    Каждая десятка выше границы успешности позволяет ускорить или замедлить время на один множитель. То есть, если Маг вытянул на 20 больше границы успшности то он может предпринять 3 действия за ход (1 по умолчанию и 2 за две десятки выше границы).
  ...
  13 Путешествие во времени 

    Каждое существо, которое Маг берет с собой, повышает Сложность заклинания на 10. Насоклько Маг превысил границу успешности, настолько лет он может переместиться.
