...
**Проверки**
  ...
  Инициатор (делает действие, выполняет проверку умения, атакует) складывает значение Параметра, Навыка и все Бонусы (если они есть) и отнимает Сложность, получившееся значение и есть модификатор стандартного значения 26. От 26 отнимается этот модификатор и это является границей успешности проверки.
