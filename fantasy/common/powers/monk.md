...
Сложность проверки 20, Сила + Выживание тоже 20, граница успешности 26.
Игрок вытаскивает карту со значением 15 - таким образом он не смог
нейтрализовать яды со сложностями 20 и 10 (т.к. для его нейтрализации
нужно значение минимум 16). А яды 5 и 7 успешно нейтрализованы.

Так же успех добавляет *<Сложность(5)>* на следующие попытки отравить
...
Воин получает *<Бонус(значение выше границы успешности этой атаки)>* на
